test_set = [
    ...
    {"query": "how does the app split a file into functions and classes", "correct_chunks": ["app/chunking.py::chunk_python_file"]},
    {"query": "what happens if a python file has a syntax error during parsing", "correct_chunks": ["app/chunking.py::chunk_python_file"]},
    {"query": "how do multiple files get chunked at once", "correct_chunks": ["app/chunking.py::chunk_file_list"]},
    ...
    {"query": "how does ast get used to parse code", "correct_chunks": ["app/chunking.py::chunk_python_file"]},
]